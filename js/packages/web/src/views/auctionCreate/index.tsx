  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List your Music NFT</h2>
        <p>
          First time listing on Helios? <a>Read our sellers&apos; guide.</a>
        </p>
      </Row>
    ...
    <>
      <Row className="call-to-action">
        ...
        <p>
          ...
          {props.attributes.quoteMintAddress != WRAPPED_SOL_MINT.toBase58() && (
            <a
              href={`https://solscan.io/address/${props.attributes?.quoteMintAddress}`}
              target="_blank"
              rel="noreferrer"
            >
              {' '}
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with Helios...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on Helios, check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,Helios',
      // via: "Helios",
      related: 'Helios,Solana',
    };
